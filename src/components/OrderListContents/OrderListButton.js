    ...
    return (
        <div className="relative">
            ...
            {items.length > 0 && (
                ...
                <span className="fixed z-20 top-10 md:top-12 left-10 md:left-12 p-2 flex-center rounded-full h-4 md:h-6 w-4 md:w-6 bg-red-600 text-white text-[12px] md:text-xs">
